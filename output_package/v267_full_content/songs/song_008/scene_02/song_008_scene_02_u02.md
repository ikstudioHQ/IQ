GENERATION UNIT: song_008_scene_02_u02
...
char_001_zayd — SINGING: return it well, The trusted heart understands.
SILENT CHARACTERS: 
...
ACTION: Close on Zayd's hands holding the plant, then watering it gently. Authored beat 2/3: use restrained, continuity-safe motion.
...
IN_STATE: {"action_state": "continue scene action", "camera_axis": "stable-front", "emotion": "scene-consistent", "location": "loc_school_classroom", "orientation": {"char_001_zayd": "toward shared action focus"}, "position": {"char_001_zayd": "stable slot 1"}, "props": {}}
