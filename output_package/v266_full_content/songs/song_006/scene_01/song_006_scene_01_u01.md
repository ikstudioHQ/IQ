GENERATION UNIT: song_006_scene_01_u01
PARENT: song song_006 / scene_01
DURATION: 7s (maximum 10s)
EXACT CHARACTER COUNT: 1
VISIBLE CANONICAL CHARACTER IDS: char_001_zayd
...
char_001_zayd — SINGING: The juice went everywhere, The puddle grew and grew, No one was in the room,
SILENT CHARACTERS: 
...
ACTION: Living room; the juice jug tips; the puddle grows; Zayd is alone. Authored beat 1/4: use restrained, continuity-safe motion.
...
IN_STATE: {"action_state": "begin scene action", "camera_axis": "stable-front", "emotion": "scene-consistent", "location": "loc_family_living_room", "orientation": {"char_001_zayd": "toward shared action focus"}, "position": {"char_001_zayd": "stable slot 1"}, "props": {}}
OUT_STATE: {"action_state": "continue scene action", "camera_axis": "stable-front", "emotion": "scene-consistent", "location": "loc_family_living_room", "orientation": {"char_001_zayd": "toward shared action focus"}, "position": {"char_001_zayd": "stable slot 1"}, "props": {}}
