...
- song_topic_id: song_019 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_kindness — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_001, hd_003 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [3, 5] — lyrics/dialogue written to this band
- characters: char_002_amira, char_001_zayd, char_079_bunbun_the_rabbit — all resolve in character_master_library.json
- typical_locations: loc_neighborhood_park
- playlist_ids: pl_001_first_words_and_small_habits, pl_005_helping_sharing_and_community
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum none | prerequisites none
- scene_type/mood: group_family_moment / warm — applied per camera_language.json
