...
- song_topic_id: song_017 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_generosity — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_007 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [3, 6] — lyrics/dialogue written to this band
- characters: char_002_amira, char_003_ummi_layla, char_013_amina — all resolve in character_master_library.json
- typical_locations: loc_family_kitchen
- playlist_ids: pl_002_home_and_family_love, pl_005_helping_sharing_and_community
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum none | prerequisites none
- scene_type/mood: group_family_moment / sharing — applied per camera_language.json
