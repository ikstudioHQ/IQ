...
- song_topic_id: song_016 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_self_control — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_006, hd_002 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [7, 8] — lyrics/dialogue written to this band
...
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum concept_patience, concept_good_speech | prerequisites none
