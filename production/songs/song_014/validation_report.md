...
- song_topic_id: song_014 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_tawakkul — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_004, qv_005, dua_005, dua_006 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [6, 7] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_002_amira, char_003_ummi_layla — all resolve in character_master_library.json
- typical_locations: loc_family_living_room
- playlist_ids: pl_004_prayer_dua_and_trust, pl_007_brave_hearts_and_big_feelings
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum concept_prayer, concept_patience | prerequisites none
- scene_type/mood: resolution_relief / trusting — applied per camera_language.json
