...
- song_topic_id: song_002 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_good_speech — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_002 — every id resolves in phase2/data/islamic/ (citation_verified: true)
...
- scene_type/mood: intimate_emotional_moment / gentle — applied per camera_language.json
...
- Duration: 105 lyric words ≈ 2:08 song + ~12s dialogue ≤ 2:30 hard cap.
