...
- song_topic_id: song_020 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_cleanliness — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_010, hd_009 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [3, 5] — lyrics/dialogue written to this band
- characters: char_002_amira, char_003_ummi_layla, char_001_zayd — all resolve in character_master_library.json
- typical_locations: loc_family_kitchen
- playlist_ids: pl_001_first_words_and_small_habits, pl_006_animals_gentleness_and_care
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum none | prerequisites none
- scene_type/mood: group_family_moment / fresh — applied per camera_language.json
