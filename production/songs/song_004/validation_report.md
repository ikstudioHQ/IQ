...
- song_topic_id: song_004 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_forgiveness — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_008 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [5, 7] — lyrics/dialogue written to this band
- characters: char_002_amira, char_009_hana, char_001_zayd — all resolve in character_master_library.json
...
- Duration: 101 lyric words ≈ 2:08 song + ~12s dialogue ≤ 2:30 hard cap.
