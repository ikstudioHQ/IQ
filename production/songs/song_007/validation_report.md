...
- song_topic_id: song_007 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_mercy — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_014, hd_003 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [5, 7] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_059_baby_sami, char_002_amira — all resolve in character_master_library.json
...
- Duration: 90 lyric words ≈ 2:08 song + ~12s dialogue ≤ 2:30 hard cap.
