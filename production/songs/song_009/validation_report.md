...
- song_topic_id: song_009 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_prayer — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_012 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [5, 7] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_004_baba_ahmad, char_003_ummi_layla — all resolve in character_master_library.json
- typical_locations: loc_family_living_room
- scene_type/mood: group_family_moment / reverent — applied per camera_language.json
...
- Duration: 107 lyric words ≈ 2:08 song + ~12s dialogue ≤ 2:30 hard cap.
