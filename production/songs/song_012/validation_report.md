...
- song_topic_id: song_012 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_friendship — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_008 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [4, 8] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_010_yusuf, char_081_idris — all resolve in character_master_library.json
- typical_locations: loc_school_classroom
- playlist_ids: pl_003_friends_school_and_speech
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum concept_kindness, concept_good_speech | prerequisites none
- scene_type/mood: group_family_moment / welcoming — applied per camera_language.json
