...
- song_topic_id: song_005 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_community — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_016, hd_012 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [6, 8] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_057_neighbor_auntie_ruqayyah, char_058_neighbor_uncle_dawud — all resolve in character_master_library.json
- typical_locations: loc_neighborhood_park
- scene_type/mood: group_family_moment / community — applied per camera_language.json
...
- Duration: 100 lyric words ≈ 2:08 song + ~12s dialogue ≤ 2:30 hard cap.
