...
- song_topic_id: song_008 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_trustworthiness — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_009 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [6, 8] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_004_baba_ahmad, char_021_ms_safiya — all resolve in character_master_library.json
- typical_locations: loc_school_classroom
- scene_type/mood: effort_action / trustworthy — applied per camera_language.json
