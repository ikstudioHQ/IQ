...
- song_topic_id: song_001 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_charity — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_011, hd_010 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [6, 8] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_010_yusuf, char_013_amina — all resolve in character_master_library.json
- typical_locations: loc_school_classroom
- scene_type/mood: group_family_moment / giving — applied per camera_language.json
...
- Duration: 109 lyric words ≈ 2:08 song + ~12s dialogue ≤ 2:30 hard cap.
