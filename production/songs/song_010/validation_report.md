...
- song_topic_id: song_010 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_perseverance — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_015 — every id resolves in phase2/data/islamic/ (citation_verified: true)
...
- scene_type/mood: effort_action / steadfast — applied per camera_language.json
