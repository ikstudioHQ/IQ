...
- song_topic_id: song_011 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_courage — concept file exists; learning goal used verbatim
- religious_evidence_ids: qv_013 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [3, 6] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_004_baba_ahmad, char_014_hamza — all resolve in character_master_library.json
- typical_locations: loc_neighborhood_park
- playlist_ids: pl_003_friends_school_and_speech, pl_007_brave_hearts_and_big_feelings
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum concept_tawakkul | prerequisites none
- scene_type/mood: effort_action / brave — applied per camera_language.json
