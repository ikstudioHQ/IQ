...
- song_topic_id: song_018 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_compassion_for_animals — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_011 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [4, 7] — lyrics/dialogue written to this band
- characters: char_001_zayd, char_002_amira, char_063_tuffy — all resolve in character_master_library.json
- typical_locations: loc_neighborhood_park
- playlist_ids: pl_006_animals_gentleness_and_care
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum concept_kindness | prerequisites none
- scene_type/mood: resolution_relief / gentle — applied per camera_language.json
