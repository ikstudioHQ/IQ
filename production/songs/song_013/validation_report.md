...
- song_topic_id: song_013 — exists in the registry, production_readiness: READY_AFTER_CHARACTER_IMPORT
- primary_concept: concept_respect_for_parents — concept file exists; learning goal used verbatim
- religious_evidence_ids: hd_001, hd_004 — every id resolves in phase2/data/islamic/ (citation_verified: true)
- age_band: [4, 6] — lyrics/dialogue written to this band
- characters: char_002_amira, char_003_ummi_layla, char_005_dada_yusuf — all resolve in character_master_library.json
- typical_locations: loc_family_living_room
- playlist_ids: pl_002_home_and_family_love
- roadmap category + dependencies: CORE_CONCEPT_ANCHOR | curriculum concept_gratitude, concept_kindness | prerequisites none
- scene_type/mood: group_family_moment / helpful — applied per camera_language.json
